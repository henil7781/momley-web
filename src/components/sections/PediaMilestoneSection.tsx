...
const MILESTONES = [
  {
    ...
    desc: "Protecting the fragile transition with zero-alcohol metabolic support and high-precision Vitamin D3 titration.",
    products: ["NeoD3 Drops", "Zymo-Drop"],
  ...
  },
  {
    ...
    desc: "Supporting explosive rapid growth and optimizing amino acid absorption during critical brain-body development.",
    products: ["Kid-LC Drops", "NeoBreathe"],
  ...
  },
  {
    ...
    title: "Immune Architecture.",
    desc: "Seeding the microbiome and building a systemic iron defense to safeguard against environmental stressors.",
    products: ["Pedia-Probio", "NeoIron"],
  ...
  },
  {
    ...
    desc: "The clinical core for active milestones—fueling neurological development and sustained physical energy.",
    products: ["PediaPlex", "Kidzine AF"],
